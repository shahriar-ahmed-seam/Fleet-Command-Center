...
ThemeData buildDriverTheme() {
  ...
  return base.copyWith(
    ...
    inputDecorationTheme: InputDecorationTheme(
      filled: true,
      fillColor: FleetColors.surfaceAlt,
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(FleetRadius.control),
        borderSide: const BorderSide(color: FleetColors.border),
      ),
      enabledBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(FleetRadius.control),
        borderSide: const BorderSide(color: FleetColors.border),
      ),
      labelStyle: const TextStyle(color: FleetColors.textMuted),
    ),
    filledButtonTheme: FilledButtonThemeData(
      style: FilledButton.styleFrom(
        backgroundColor: FleetColors.primary,
        foregroundColor: FleetColors.bg,
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(FleetRadius.control),
        ),
